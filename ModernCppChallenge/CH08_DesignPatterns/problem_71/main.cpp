 ...
 * @brief Observable vector container
 * @version 0.1
 * @date 2024-01-22
 * 
 ...
 * @brief Observable vector container
 * 
 * Write a class template that behaves like a vector 
 * but can notify registered parties of internal state changes.
 * 
 */
...
public:
    virtual void collection_changed(collection_change_notification notification) override
    {
        ...
        {
            std::cout << ", indexes: ";
            for (auto i : notification.item_indexes) std::cout << i << ' ';
        }
        std::cout << std::endl;
    }
};
