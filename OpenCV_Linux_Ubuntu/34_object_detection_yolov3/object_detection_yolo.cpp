/**
 * @File    : object_detection_yolo.cpp
 * @Brief   : 利用 YOLO V3 进行目标检测
 * @Usage   :  ./object_detection_yolo image.jpg
 * // This code is based on LearnOpenCV code writtend at BigVision LLC //
 * @Author  : Wei Li
 * @Date    : 2021-08-12
*/
...
int main(int argc, char **argv)
{
    ...
    imshow("Deep Learning. Chapter 15", input);
    waitKey(0);
