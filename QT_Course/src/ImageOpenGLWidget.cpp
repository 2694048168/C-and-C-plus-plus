...
ImageOpenGLWidget::ImageOpenGLWidget(QWidget *parent)
    : QOpenGLWidget(parent)
{
}

void ImageOpenGLWidget::initTextures()
{
    // 加载 Avengers.jpg 图片
...
void ImageOpenGLWidget::initShaders()
{
    //纹理坐标
...
void ImageOpenGLWidget::setImage(const QImage &image)
{
