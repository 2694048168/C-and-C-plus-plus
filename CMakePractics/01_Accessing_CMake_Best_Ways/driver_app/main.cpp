 ...
 * throws.
 */
std::unique_ptr<framework::components::component_interface> component_factory(component_type ct) noexcept(false)
{
    switch (ct)
    {
    case component_type::component1:
        return std::unique_ptr<framework::components::component1>(new framework::components::component1());
    case component_type::component2:
        return std::unique_ptr<framework::components::component2>(new framework::components::component2());
    }
