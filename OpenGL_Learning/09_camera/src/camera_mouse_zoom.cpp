...
int main(int argc, char const *argv[])
{
    ...
    // ------------------------------------
    const char *path2vertex = "./../09_camera/shader/vertex.glsl";
    const char *path2fragment = "./../09_camera/shader/fragment.glsl";
...
void processInput(GLFWwindow *window)
{
    ...
    // WASD 键的任意一个,摄像机的位置都会相应更新; 'A' || 'D' || 'W' || 'S'
